  ...
  return (
    <html lang="pt-BR">
      <body className="bg-slate-50 text-slate-900 min-h-screen antialiased font-sans">
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-0 focus:left-0 focus:z-[9999] focus:bg-blue-600 focus:text-white focus:px-4 focus:py-3 focus:rounded-br-xl focus:font-semibold"
        >
