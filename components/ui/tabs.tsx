...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      // mobile
      "flex-shrink-0 flex items-center gap-1.5 px-4 py-3.5 text-base font-semibold text-slate-500 border-b-2 border-transparent -mb-px transition-all whitespace-nowrap",
